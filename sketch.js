...
btnYes2 = createButton('Yes');
btnYes3 = createButton('Yes');
btnYes4 = createButton('Yes');
btnYes5 = createButton('Yes');
btnYes6 = createButton('Yes');
btnYes7 = createButton('Yes');
btnYes8 = createButton('YES, I loved It');

btnNo1 = createButton('NO, It Is My First Survey');
btnNo2 = createButton('NO');
btnNo3 = createButton('NO');
btnNo4 = createButton('NO');
btnNo5 = createButton('NO');
btnNo6 = createButton('NO');
btnNo7 = createButton('NO');
...
if (g === 0) {
  ...
  if (g===1) {
    ...
    text("Q.2 : Do you have fever(hight temperature)?",30,150);
    ...
    text("Q.3 : Do you have dry cough?",30,150);
    ...
    text("Q.4 : Do you feel tired and weak? ",30,150);
    ...
    text("Q.5 :Do you have any of the following:high blood pressure, heart and lung problems, diabetes, or cancer.",30,150);
    ...
    text("Q.6 : Do you face difficulty in breathing ?",30,150);
    ...
    text("Q.7 : Have been around people who have been affected by the virus?",30,150);
